 ...
 *
 * Browsers report standard BCP-47 tags (`zh-CN`, `zh-Hans`, `zh`, ...), but
 * `supportedLngs`/resources use the non-standard camelCase codes, so without
 ...
 * matching still applies (e.g. `en-US` -> `en`).
 */
